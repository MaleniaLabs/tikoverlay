...
1. Clone or download the project repository to your local machine:
   ```bash
   git clone https://github.com/MaleniaLabs/tikoverlay.git
   cd tikoverlay
   ```
...
* `TikOverlay-Setup-<version>.exe` (Standard NSIS installer)
* `TikOverlay-Portable-<version>.exe` (Standalone portable application)
